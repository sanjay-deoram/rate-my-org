  ...
  return (
    <>
      ...
      <main className="relative min-h-screen overflow-hidden pt-20">
        ...
        <section className="relative z-10 mx-auto max-w-5xl px-5 py-12 md:px-12 md:py-24">
          {/* Header */}
          <div className="mb-10 md:mb-12">
            <span className="text-on-surface-variant mb-3 block font-mono text-[10px] tracking-[0.2em] uppercase">
              Organizational Directory
            </span>
            <h1 className="text-foreground mb-3 text-3xl font-bold md:text-5xl">Companies</h1>
