  ...
  if (variant === "directory") {
    return (
      ...
      >
        ...
        <span className="bg-ink/90 absolute top-72 right-24 hidden h-7 w-16 rotate-[-16deg] rounded-md lg:block lg:h-10 lg:w-24" />
      </div>
    );
  }
  ...
  if (variant === "archive") {
    return (
      ...
      >
        ...
        <span className="bg-token-lime/70 absolute -right-6 bottom-2 h-16 w-20 rotate-[-4deg] rounded-[1rem] sm:right-6 sm:bottom-4 sm:h-20 sm:w-28 md:right-10 md:bottom-6 md:h-28 md:w-72" />
        <span className="bg-ink/90 absolute top-24 right-28 hidden h-6 w-16 rotate-[14deg] rounded lg:block lg:h-9 lg:w-24" />
      </div>
    );
  }
  ...
  if (variant === "form") {
    return (
      ...
      >
        ...
        <span className="bg-ink/90 absolute top-[26rem] right-28 hidden h-7 w-20 rotate-[-18deg] rounded-md xl:block xl:h-10 xl:w-28" />
      </div>
    );
  }
  ...
  if (variant === "about") {
    return (
      ...
      >
        ...
        <span className="bg-ink/90 absolute right-32 bottom-20 hidden h-8 w-20 rotate-[-14deg] rounded-md lg:block lg:h-12 lg:w-32" />
      </div>
    );
  }
